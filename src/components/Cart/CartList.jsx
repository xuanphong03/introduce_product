...
function CartList(props) {
  ...
  return (
    <div className="border border-solid border-gray-300 w-[400px] h-[500px] overflow-y-auto p-4 bg-red-50 rounded-md">
      <h4 className="bg-slate-300 rounded-t-md fixed top-0 left-0 right-0 text-center uppercase text-xl font-mono py-2 mb-3">
        Product cart
      </h4>
      ...
      <div className="bg-slate-300 rounded-b-md font-mono fixed text-xl left-0 bottom-0 right-0">
